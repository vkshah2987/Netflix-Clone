...
const Hero: React.FC<HeroProps> = ({ state }) => {
    ...
    return (
        ...
        <div
            ...
            className='relative z-1 w-full min-h-[75vw] lg:min-h-[60vw] bg-no-repeat bg-cover bg-center'>
                ...
                <div className="absolute flex justify-between h-full w-full text-white z-10 pl-[3.5vw]">
                    <div className="w-[35vw] pt-[20vw] lg:pt-[8vw] flex flex-col">
                    ...
                    <div className="flex items-center mt-[47vw] lg:mt-[38vw] bg-[rgba(51,51,51,0.6)] border-l-[3px] border-[#dcdcdc] solid box-border text-[1.1vw] h-[2.4vw] px-[3.5vw] py-[0.5vw] pl-[0.8vw] tracking-wide">
                        {data?.rating}
                    </div>
                </div>
        </div>
